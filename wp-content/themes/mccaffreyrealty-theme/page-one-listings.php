						...
						<main id="main" class="m-all t-2of3 d-all cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article">
								...
								?>
									...
									<div class="overview">
										<h1 class="h2 entry-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a>, <span class="location"><?php echo $location; ?></span></h1>
